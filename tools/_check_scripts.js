...
let h = `<div class="atr-cover-library-actions atr-cover-dot-actions">`;
h += `<details class="mock-card-menu atr-cover-dot-menu">`;
...
(function(){
  ...
  function card(f){const t=typeOf(f); const sub=esc(f.path&&f.path!==f.name?f.path:noExt(f.name)); const coverActions=(typeof atrLibraryCoverActionsHtml==='function')?atrLibraryCoverActionsHtml(f.name):''; return '<article class="mock-lib-card" data-file-name="'+esc(f.name)+'" data-file-path="'+esc(f.path)+'" data-file-type="'+esc(t)+'"><div class="mock-lib-cover-wrap"><span class="mock-lib-type">'+esc(t)+'</span>'+cover(f.name)+'</div><div class="mock-lib-title" title="'+esc(f.name)+'">'+esc(f.name)+'</div><div class="mock-lib-subtitle" title="'+sub+'">'+sub+'</div>'+coverActions+'<div class="mock-lib-meta"><span>'+human(f.fileSize)+'</span><span>'+(t==='CAS'?'Cassette':(f.sectorSize?esc(f.sectorSize+'B'):'—'))+'</span><span>'+(f.totalSectors?esc(f.totalSectors+' sec.'):'—')+'</span>'+(f.protected?'<span>Protegido</span>':'')+'</div>'+casProfileHtml(f)+casProfileControlsHtml(f)+'<div class="mock-lib-units">'+unitsHtml(f)+'</div></article>';}
  function ensureStyle(){if($('libraryF22Style'))return; const st=document.createElement('style'); st.id='libraryF22Style'; st.textContent='#atrLibrary,#atrLibraryPager,body.route-library #mockFilterChipsF27,body.route-library #libraryGridF19,body.route-library #libraryGridF20,body.route-library #libraryGridF21,body.route-library #libraryF19Pager,body.route-library #libraryF20Pager,body.route-library #libraryF21Pager,body.route-library #libraryF19Chips,body.route-library #libraryF20Chips,body.route-library #libraryF21Chips,body.route-library #libraryF19Diag,body.route-library #libraryF20Diag,body.route-library #libraryF21Diag{display:none!important} #libraryF22Chips{display:flex;flex-wrap:wrap;gap:8px;margin:10px 0} #libraryF22Pager{display:flex;flex-wrap:wrap;gap:10px;align-items:center;justify-content:center;margin:12px 0} #libraryGridF22.mock-lib-grid{display:grid!important;grid-template-columns:repeat(auto-fill,minmax(var(--lib-card-min,220px),1fr));gap:16px!important;margin-top:10px} #libraryF22Diag{font-size:12px;color:#9fb6c8;margin:6px 0 0}.f22-lazy-cover[data-loaded="1"]{display:block}.f22-lazy-cover[data-error="1"]{display:none}.mock-filter-chip[hidden]{display:none!important} #libraryGridF22 .atr-cover-library-actions{display:flex!important;flex-wrap:wrap;gap:6px;margin:8px 0 10px;justify-content:center} #libraryGridF22 .atr-cover-mini-btn{font-size:11px;padding:5px 7px;border-radius:999px;line-height:1.1} #libraryGridF22 .atr-cover-dot-actions{display:flex!important;justify-content:center!important;align-items:center!important;margin:8px 0 10px!important} #libraryGridF22 .atr-cover-dot-menu{margin:0!important;display:inline-block!important;position:relative!important} #libraryGridF22 .atr-cover-dot-menu summary{width:32px!important;height:28px!important;min-width:32px!important;display:flex!important;align-items:center!important;justify-content:center!important;border-radius:9px!important;border:1px solid rgba(56,189,248,.42)!important;background:linear-gradient(135deg,#0ea5e9,#2563eb)!important;color:#fff!important;font-size:18px!important;font-weight:900!important;line-height:1!important;padding:0!important;cursor:pointer!important} #libraryGridF22 .atr-cover-dot-menu-body{right:50%!important;bottom:34px!important;transform:translateX(50%)!important;min-width:190px!important} #libraryGridF22 .atr-cover-dot-menu-body .atr-cover-mini-btn{width:100%!important;text-align:left!important;justify-content:flex-start!important;border-radius:10px!important;padding:7px 9px!important}'; document.head.appendChild(st);}
